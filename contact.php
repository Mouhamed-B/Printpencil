...
<div class="content container-fluid">
  <h1 align="center"><?if (isset($_POST['cmd'])) {echo "Commander sur Printprencil";}else {echo "Contacter Printprencil";} ?></h1><hr>
  <div class="row">
    ...
    <div class="tab-content col-md-10">
      <div class="tab-pane active" id="form">
        <form  action="dashboard.php" method="post">
          ...
          <div class="form-group">
            <label for="d"><?if (isset($_POST['cmd'])) {echo "Description de la Commande";} else {echo "Message";} ?></label>
            <textarea rows="6" required="required" id="d" class="form-control" name="msg">
            </textarea>  
          </div>
          <a href="#"><button class="btn btn-primary" type="submit"><?if (isset($_POST['cmd'])) {echo "Passer la commande";}else {echo "Envoyer";} ?></button><br><br></a>
        </form> 
      </div>
      <? if (isset($_POST['cmd'])) {
        echo "<!--";
    ...
    <div class="tab-pane" id="mail">
      <div class="container">
        <p><h2><?if (isset($_POST['cmd'])){echo "Prenez rendez-vous";} else {echo "Joignez nous";} ?> selon vos besoins</h2><br>
